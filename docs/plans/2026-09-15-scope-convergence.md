...
```
Expected: 仅剩 **22 条**：R1–R7（7）+ §9.5/§10.5/§14 验收门槛（5+6+1=12）+ §12 推送（3）；**不应再出现 I/K/M2-M6/N2.7/Q2-Q4/Z 批次的功能条目**。
...
| 验收门槛 | ~21 | OPTIMIZATION_PLAN §9.5/§10.5/§14（12）+ ADMIN_PLAN §10（6）+ PLAN 验收红线（1） |
| 推送 | 3 | OPTIMIZATION_PLAN §12 |
